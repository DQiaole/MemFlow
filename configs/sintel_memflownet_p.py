...
_CN.name = ''
_CN.suffix = 'sintel_memflownet_p'
_CN.gamma = 0.85
_CN.max_flow = 400
_CN.batch_size = 8
_CN.sum_freq = 100
_CN.val_freq = 5000
_CN.image_size = [368, 768]
_CN.add_noise = False
...
# _CN.restore_ckpt = 'ckpts/skflow-sintel.pth'
...
_CN.train_avg_length = (368 * 768 // 64) * 1 / 2
_CN.mem_every = 1
_CN.top_k = None
